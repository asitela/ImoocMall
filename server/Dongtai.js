...
server.listen(5000, 'localhost', () => { // 这里如果写的是本机Ip地址，那么在浏览器里打开的时候也得写本机的ip地址才行，如果写的是localhost，那么在浏览器里写localhost就行了
  console.log('服务器已经运行，请打开浏览器，输入:http://localhost:5000/ 来进行访问.')
})
